...
O Saasdeep Softwares segue uma arquitetura em camadas com limites claros entre o navegador, API, autenticação, banco de dados e módulos fiscais.
...
5. Os procedures do tRPC usam o **Drizzle ORM** para acesso ao banco de dados e o **@saasdeep/fiscal** para operações fiscais
...
| Pacote fiscal independente | `@saasdeep/fiscal` não tem dependência de banco de dados, reutilizável em qualquer projeto TS |
