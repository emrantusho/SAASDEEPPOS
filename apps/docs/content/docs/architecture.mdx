...
Saasdeep Softwares follows a layered architecture with clear boundaries between the browser, API, authentication, database and fiscal modules.
...
5. tRPC procedures use **Drizzle ORM** for database access and **@saasdeep/fiscal** for fiscal operations
...
| Standalone fiscal package | `@saasdeep/fiscal` has zero database deps, reusable in any TS project |
