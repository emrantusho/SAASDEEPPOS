...
[@saasdeep/fiscal](/docs/api-reference/index) / buildSubstitutionCancellationXml
...
Constroi o XML do evento de cancelamento por substituicao (apenas NFC-e modelo 65).
