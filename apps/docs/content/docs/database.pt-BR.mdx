...
O Saasdeep Softwares usa **PGLite** — PostgreSQL completo rodando como WASM dentro do processo Node.js. Nenhum servidor de banco de dados externo é necessário. Os dados são armazenados no sistema de arquivos em `apps/web/data/pglite`.
