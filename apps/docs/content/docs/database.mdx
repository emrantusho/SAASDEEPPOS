...
Saasdeep Softwares uses **PGLite** — full PostgreSQL running as WASM inside the Node.js process. No external database server required. Data is stored on the filesystem at `apps/web/data/pglite`.
