...
description: How Saasdeep Softwares handles your data
---

**Last updated:** March 10, 2026

This Privacy Policy describes how Saasdeep Softwares ("we", "us", "our") collects, uses, and protects your personal data when you use the Saasdeep Softwares demo application hosted at **fin-open-pos.johnenrique.tech** (the "Service"). This policy complies with the Brazilian General Data Protection Law (LGPD — Lei 13.709/2018) and the European General Data Protection Regulation (GDPR — Regulation EU 2016/679).

---

## 1. Data Controller

**Saasdeep Softwares Community**
...
Saasdeep Softwares is open-source software licensed under the MIT License. The complete source code, including all data handling logic, is publicly available for inspection at our [GitHub repository](https://github.com/JoaoHenriqueBarbosa/FinOpenPOS).
