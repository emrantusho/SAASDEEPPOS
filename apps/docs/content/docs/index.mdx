...
## What is Saasdeep Softwares?

Saasdeep Softwares is an open-source Point of Sale (POS) and inventory management system with a **Brazilian fiscal module** (NF-e/NFC-e). Built with Next.js 16, React 19 and embedded PostgreSQL via PGLite. Turborepo monorepo with the fiscal module as a standalone package.
