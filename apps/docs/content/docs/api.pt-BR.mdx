...
O Saasdeep Softwares usa **tRPC v11** para comunicação de API type-safe de ponta a ponta. Todos os procedures requerem autenticação via cookie de sessão do Better Auth.
